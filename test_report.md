...
| 9 | **User - Contact** | Input Contact Form | Positive | **Precondition:**<br>User akses halaman Contact<br><br>**Steps:**<br>1. Buka menu "Contact"<br>2. Isi Nama, Email, Pesan<br>3. Klik "Send Message" | Name: "Test User"<br>Email: "test@mail.com" | Form tervalidasi. | As Expected | As Expected | **Passed** | [Link](#) |
