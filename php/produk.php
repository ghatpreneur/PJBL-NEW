...
<head>
  ...
  <link rel="stylesheet" href="produk.css?v=2" />
    ...
    <div class="sidebar">
      <div class="sidebar-top">
        ...
        <div class="menu-items">
          <a class="menu-item active" href="produk.php">
          ...
          <a class="menu-item" href="customer_analytics.php">
      ...
      <a href="new_product.php" class="btn btn-primary sidebar-cta">Create Product</a>
    </div> 
    <div class="content">
          ...
          <table class="product-table">
            <thead>
              <tr>
                ...
                <th class="th-status">Category</th>
            ...
            <tbody>
              ...
              <tr class="product-row">
                ...
                <td class="td-status">
                  ...
                  $categoryLabel = $category === 'ready_to_use' ? 'Ready to Use' : 'Custom';
                  ?>
                  <span class="status-btn <?php echo $category === 'ready_to_use' ? 'category-ready' : 'category-custom'; ?>">
                    <?php echo htmlspecialchars($categoryLabel); ?>
                  </span>
                </td>
                
                <td class="td-status">
                  <span class="status-btn <?php echo $row['status'] === 'sold' ? 'status-sold' : 'status-in-stock'; ?>">
